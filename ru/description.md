Спасибо за прямое замечание и корректировку — переписываю файл по правилам: **беру только то, что в приложенных файлах; старые формулировки — только если информации больше нигде нет**.
